...
```Q#
IncrementPhaseByInteger (increment : Int, target : Microsoft.Quantum.Arithmetic.PhaseLittleEndian) : Unit
```
...
- [Microsoft.Quantum.Arithmetic.IncrementByIntegerBE](xref:Microsoft.Quantum.Arithmetic.IncrementByIntegerBE)
- [Microsoft.Quantum.Arithmetic.IncrementByIntegerLE](xref:Microsoft.Quantum.Arithmetic.IncrementByIntegerLE)