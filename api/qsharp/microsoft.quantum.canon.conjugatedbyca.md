...
### outerOperation : 'T => [Unit](xref:microsoft.quantum.user-guide.language.types)  is Adj

The operation $U$ that should be used to conjugate $V$. Note that theouter operation $U$ needs to be adjointable, but does notneed to be controllable.


### innerOperation : 'T => [Unit](xref:microsoft.quantum.user-guide.language.types)  is Adj + Ctl

The operation $V$ being conjugated.



## Output : 'T => [Unit](xref:microsoft.quantum.user-guide.language.types)  is Adj + Ctl
