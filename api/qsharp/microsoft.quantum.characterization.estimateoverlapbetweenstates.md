...
```Q#
EstimateOverlapBetweenStates (preparation1 : (Qubit[] => Unit is Adj), preparation2 : (Qubit[] => Unit is Adj), nQubits : Int, nMeasurements : Int) : Double
```


## Input

### preparation1 : Qubit[] => Unit Adj

The first of the two state preparation operations to be compared.


### preparation2 : Qubit[] => Unit Adj
