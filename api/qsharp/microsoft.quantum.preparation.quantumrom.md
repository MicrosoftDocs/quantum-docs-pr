...
## Output : (([Int](xref:microsoft.quantum.user-guide.language.types),([Int](xref:microsoft.quantum.user-guide.language.types),[Int](xref:microsoft.quantum.user-guide.language.types))),[Double](xref:microsoft.quantum.user-guide.language.types),([LittleEndian](xref:Microsoft.Quantum.Arithmetic.LittleEndian),[Qubit](xref:microsoft.quantum.concepts.the-qubit)[]) => [Unit](xref:microsoft.quantum.user-guide.language.types)  is Adj + Ctl)
