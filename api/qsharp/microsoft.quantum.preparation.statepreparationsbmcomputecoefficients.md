...
## Output : ([Double](xref:microsoft.quantum.user-guide.language.types)[],[Double](xref:microsoft.quantum.user-guide.language.types)[],[ComplexPolar](xref:Microsoft.Quantum.Math.ComplexPolar)[])
