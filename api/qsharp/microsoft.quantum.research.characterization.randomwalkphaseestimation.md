...
### initialMean : [Double](xref:microsoft.quantum.user-guide.language.types)

Mean of the initial normal prior distribution over $\phi$.


### initialStdDev : [Double](xref:microsoft.quantum.user-guide.language.types)
...
### maxMeasurements : [Int](xref:microsoft.quantum.user-guide.language.types)

Total number of measurements than can be taken before the operation is considered to have failed.


### unwind : [Int](xref:microsoft.quantum.user-guide.language.types)
