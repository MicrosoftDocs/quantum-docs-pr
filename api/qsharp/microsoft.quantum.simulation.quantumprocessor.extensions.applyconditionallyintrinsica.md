...
### onEqualOp : [Unit](xref:microsoft.quantum.user-guide.language.types) => [Unit](xref:microsoft.quantum.user-guide.language.types)  is Adj




### onNonEqualOp : [Unit](xref:microsoft.quantum.user-guide.language.types) => [Unit](xref:microsoft.quantum.user-guide.language.types)  is Adj
