...
### onResultZeroOp : [Unit](xref:microsoft.quantum.user-guide.language.types) => [Unit](xref:microsoft.quantum.user-guide.language.types)  is Adj




### onResultOneOp : [Unit](xref:microsoft.quantum.user-guide.language.types) => [Unit](xref:microsoft.quantum.user-guide.language.types)  is Adj
