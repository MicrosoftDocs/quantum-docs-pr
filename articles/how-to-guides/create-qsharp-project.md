...
1. Pre-requisites
    ...
    - The [Quantum Development Kit for Python](~/install#develop-with-python)
...
1. Pre-requisites
    ...
    - The [Quantum Development Kit for Jupyter notebooks](~/install#develop-with-jupyter)
...
1. Pre-requisites
    ...
    - The [Quantum Development Kit for Visual Studio](~/install#develop-with-visual-studio)
...
1. Pre-requisites
    ...
    - The [Quantum Development Kit for VS Code](~/install#develop-with-vs-code)
...
1. Pre-requisites
    ...
    - The [Quantum Development Kit for the Command Line](~/install#develop-with-command-line)
