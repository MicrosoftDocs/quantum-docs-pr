...
- [Q# command line application](microsoft.quantum.install.standalone) choose this approach if you want to work with Q# from the command line. This is does not require a driver or a host program like the below options.
