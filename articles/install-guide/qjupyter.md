...
- You can take a look to the [IQ\# code sample](https://docs.microsoft.com/en-us/samples/microsoft/quantum/intro-to-qsharp-jupyter/). There you will find a Q# Jupyter Notebook that shows how to use Q# in this environment.
