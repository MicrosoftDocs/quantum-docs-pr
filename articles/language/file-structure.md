...
When a project is used as a reference, all of its non-internal declarations are made available, but trying to use an internal declaration from another project will produce an error.
