...
This is useful for writing modular code that can be reused by other parts of your project, which can still be changed later without breaking other projects that might depend on it.
