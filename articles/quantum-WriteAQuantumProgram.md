...
earlier. It will start with a qubit in a basis state $\ket{0}$, rotate it by a given angle, 
teleport it, un-rotate the target qubit, measure it and verify that the result is $\ket{0}$.
