...
While a bit, or binary digit, can have value either $0$ or $1$, a qubit can have a value that is either of these or [a quantum superposition](https://en.wikipedia.org/wiki/Quantum_superposition) of $0$ and $1$.
