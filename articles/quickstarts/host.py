import qsharp # Importing Q#
from Quantum import QuantumRandomNumberGenerator # We import the 
# quantum operation from the namespace defined in the .qs file
...
print("The random number generated is " + str(output)) # We print the random number
