...
|&nbsp; | **VS Code<br>(2019 or later)**<br>:::image type="icon" source="~/media/vs_code.png" :::| **Visual Studio<br>(2019 or later)**<br>![<img src="~/media/vs_studio.png" width="150"/>](vs_studio.png) | **Jupyter Notebooks**<br> ![Jupyter](~media/jupyter.png) | **Command line**|
|:-----|:-----:|:-----:|:-----:|:-----:|
