...
2. In a text editor, edit the .csproj file to change the version of all 
   the "Microsoft.Quantum" `PackageReference` to version 0.3.1810.2508-preview, for example:
```xml
    <PackageReference Include="Microsoft.Quantum.Canon" Version="0.3.1810.2508" />
    <PackageReference Include="Microsoft.Quantum.Development.Kit" Version="0.3.1810.2508" />
```
...
In order to facilitate project migration, a PowerShell script is provided that can be downloaded [here](https://solidrepo.blob.core.windows.net/release/0.3.1810.803/qdk-migrate.ps1).
