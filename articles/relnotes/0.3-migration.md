...
2. In a text editor, edit the .csproj file to change the version of all 
   the "Microsoft.Quantum" `PackageReference` to version 0.3.1811.1501-preview, for example:
```xml
    <PackageReference Include="Microsoft.Quantum.Canon" Version="0.3.1811.1501" />
    <PackageReference Include="Microsoft.Quantum.Development.Kit" Version="0.3.1811.1501" />
```
