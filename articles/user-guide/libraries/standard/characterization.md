...
Having observed a `Result` from the iterative phase estimation likelihood function, you can then use Bayes' rule to prescribe what you believe the phase to be following that observation.
Concretely,
\begin{equation}
